...
def prepare_data(df_data, columns):
    ...
    for key in columns:
        data_filter = df_data[[key, "encoding"]]
        ...
        df_values['Pre-trained model'] = data_filter['encoding']
...
df_data = df_data.loc[df_data['Method'] == 'PLM']
...
g1 =sns.boxplot(ax=axes[0][0], data=df_accuracy, x="Performance", y="Stage", hue="Pre-trained model")
axes[0][0].set_title("Accuracy")

g2 =sns.boxplot(ax=axes[0][1], data=df_precision, x="Performance", y="Stage", hue="Pre-trained model")
axes[0][1].set_title("Precision")

g3 =sns.boxplot(ax=axes[1][0], data=df_recall, x="Performance", y="Stage", hue="Pre-trained model")
axes[1][0].set_title("Recall")

g4 =sns.boxplot(ax=axes[1][1], data=df_fscore, x="Performance", y="Stage", hue="Pre-trained model")
axes[1][1].set_title("F1-score")

plt.savefig("../../save_plots/performances_by_training_method_filter.svg")
